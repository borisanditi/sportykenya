        ...
        <>
            <header className="bg-brand-black text-white sticky top-0 z-50">
                <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
                    ...
                    {/* Leagues hamburger button — desktop right side */}
                    <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                        <button
                            onClick={() => setLeaguesOpen(true)}
                            className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-semibold text-white hover:bg-white/10 hover:text-brand-gold transition-all duration-150"
                            ...
                            <div className="-my-6 divide-y divide-gray-500/10">
                                ...
                                <div className="py-4">
                                    <button
                                        ...
                                        className="-mx-3 flex items-center gap-3 rounded-lg px-3 py-2 text-base font-semibold leading-7 text-brand-gold hover:bg-white/10 w-full"
                                    >
                                        <LayoutGrid className="h-5 w-5" />
                                        Leagues
                                    </button>
            ...
            {/* Leagues drawer — outside header so it overlays full viewport */}
            <LeaguesDrawer open={leaguesOpen} onClose={() => setLeaguesOpen(false)} />
        </>
    );
}
